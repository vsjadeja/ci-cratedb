...
use Doctrine\DBAL\Types\TimestampType;
...
class CratePlatform extends AbstractPlatform
{
    ...
    public function __construct()
    {
        ...
        if (!Type::hasType(MapType::NAME)) {
            Type::addType(MapType::NAME, 'Doctrine\DBAL\Types\MapType');
        }
        if (!Type::hasType(TimestampType::NAME)) {
            Type::addType(TimestampType::NAME, 'Doctrine\DBAL\Types\TimestampType');
        }
        Type::overrideType('array', 'Doctrine\DBAL\Types\ArrayType');
    }
    ...
    {
        return 'Doctrine\DBAL\Platforms\Keywords\CrateKeywords';
    }
